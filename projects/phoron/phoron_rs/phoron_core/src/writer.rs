...
mod tests {
    ...
    fn test_write_unsigned_byte() {
        ...
        writer.write_unsigned_byte(0xca);
        writer.write_unsigned_byte(0xfe);
        writer.write_unsigned_byte(0xba);
        writer.write_unsigned_byte(0xbe);
    ...
    fn test_write_unsigned_short() {
        ...
        let mut writer = Writer::new(&mut buf);
        writer.write_unsigned_short(0xcafe);
        writer.write_unsigned_short(0xbabe);
    ...
    fn test_write_unsigned_int() {
        ...
        let mut writer = Writer::new(&mut buf);
        writer.write_unsigned_int(0xcafebabe);
    ...
    fn test_write_unsigned_long() {
        ...
        let mut writer = Writer::new(&mut buf);
        writer.write_unsigned_long(0x00000041000f0a00);
